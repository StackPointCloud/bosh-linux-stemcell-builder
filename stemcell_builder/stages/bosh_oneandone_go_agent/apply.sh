...
cd $assets_dir
if is_ppc64le; then
  curl -L -o bosh-agent "https://www.dropbox.com/s/j30igk1k51wtgji/bosh-agent-2.65.0-linux-ppc64le?dl=0"
  echo "f70cb0ab0e5f76854a4a6341f7b4d99f879536ce5cfb604e5e8ce6e2c9e63649  bosh-agent" | shasum -a 256 -c -
else
  curl -L -o bosh-agent "https://www.dropbox.com/s/j30igk1k51wtgji/bosh-agent-2.65.0-linux-ppc64le?dl=0"
  echo "f70cb0ab0e5f76854a4a6341f7b4d99f879536ce5cfb604e5e8ce6e2c9e63649  bosh-agent" | shasum -a 256 -c -
fi
